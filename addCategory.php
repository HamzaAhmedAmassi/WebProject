                                    ...
                                    <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projection1">Category Name</label>
                                                        <input type="text" id="projection1" class="form-control" placeholder="Category Name"
                                                               name="c_name">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projection2">Category Description</label>
                                                        <input type="text" id="projection2" class="form-control" placeholder="Category Description"
                                                               name="c_description">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projection3">status</label>
                                                        <input type="checkbox" id="projection3"
                                                               name="status" value="1">
                                                    </div>
                                                </div>
