...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (count($errors) >0){
        ...
        $query="UPDATE category set name = '$name' , description ='$description' , status='$status' , updated_at='$date'
        where id = '".$_GET['id']."'
" ;
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Category Description"
                                                               name="c_description" value="<?php echo $row['description'] ?>" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" id="projectinput3"
                                                               name="status" value="1"
                                                            <?php
                                                                if ($row['status'] == 1){
                                                                    echo 'checked';
